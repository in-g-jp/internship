...
| Step | 内容 | Udemy セクション | 視聴時間 |
|------|------|-----------------|----------|
| Step 0 | Laravel の概要 | セクション 1・2 | 17 分 |
| Step 1 | ルーティング | セクション 5 | 31 分 |
| Step 2 | コントローラー + リクエスト | セクション 7 | 50 分 |
| Step 3 | マイグレーション | セクション 8 | 77 分 |
| Step 4 | モデル・Eloquent | セクション 9 | 110 分 |
| Step 5 | ここまでの実践（流れ確認） | セクション 10 | 22 分 |
| Step 6 | 検索・フィルタリング | セクション 11 | 47 分 |
| Step 7 | ソフトデリート | セクション 12 | 25 分 |
| Step 8 | ページネーション | セクション 13 | 30 分 |
| Step 9 | 外部ストレージ（S3） | セクション 14 | 4 分 |
| Step 10 | 認証・ミドルウェア（概念把握のみ） | セクション 15・17 | 14 分 |
| **合計** | **11 Steps** | | **約 7 時間 7 分** |

---

## 視聴順

### Step 0 — Laravel の概要（17 分）
